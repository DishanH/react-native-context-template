  ...
  public: {
    Tables: {
      ...
      subscriptions: {
        Row: {
          ...
          status: "active" | "cancelled" | "expired" | "trial" | "canceled";
          start_date: string;
          end_date: string;
          auto_renew: boolean;
    ...
    Enums: {
      ...
      discussion_type:
        ...
        | "discussion"
        | "weekly-question";
      message_type: "text" | "supportRequest" | "celebrationShare";
      playbook_difficulty: "Essential" | "Intermediate" | "Advanced";
    };
  };
};
...
export type DiscussionType = Database["public"]["Enums"]["discussion_type"];
export type MessageType = Database["public"]["Enums"]["message_type"];
export type PlaybookDifficulty =
  Database["public"]["Enums"]["playbook_difficulty"];
